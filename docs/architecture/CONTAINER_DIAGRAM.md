...
| **Phase 1 — Capture** | Watches inbox for dropped files. 5-stage pipeline: extract text → enrich URLs → AI summarize → AI label → write to vault. Handles .md, PDF, DOCX, XLSX. Includes `kms reconcile` to repair orphaned files. |
